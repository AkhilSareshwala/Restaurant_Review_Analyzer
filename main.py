...
llm = ChatGoogleGenerativeAI(model="gemini-1.5-flash", temperature=0.7, google_api_key="AIzaSyAU_7XCPFKWQKU_OKvt-XlgBZ3HmESESIc")
embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001", google_api_key="AIzaSyDjLk9btxSp_LbS-Yw548xemRogNdHB0xY")
